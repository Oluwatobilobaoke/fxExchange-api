exports.emailAlreadyRegistered = async (firstName, url) => {
  const html = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Email Verification . Zeek Xchange</title>
        ...
        <body>
            <header>
                <img width="250" src="/img/characters.svg" alt="" class="img-fluid header-img">
            ...
            <section class="container-fluid">
                <div class="content">
                    ...
                    <p>
                        Glad to have you join us. Your email has already been registered and verified
                    </p>

                    <p>kindly click <a href='${url}'>here</a> to login into your account</p>
                </div>
            </section>
            <footer>
                <div class="container">
