  ...
  const html = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            ...
            <title>Withdrawal . CoinInvestify</title>
        ...
        <body>
            <header>
                <img width="300" src="/img/withdrawal.svg" alt="" class="img-fluid header-img">
            ...
            <footer>
                <div class="container">
                    <h1 class="footer-header">CoinInvestify</h1>
                    <div class="divider"></div>
                    <p>Email: <a href="mailto:info@coininvestify.com">info@coininvestify.com</a></p>
